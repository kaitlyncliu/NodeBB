...
interface PostHandlerType {
    bookmark: (pid: number, uid: string) => Promise<ToggleBookmarkPayloadType>;
    unbookmark: (pid: number, uid: string) => Promise<ToggleBookmarkPayloadType>;
    getPostFields: (pid: number, field: string[]) => Promise<any>;
    hasBookmarked: (pid: number, uid: string) => Promise<boolean>;
    setPostField: (pid: number, field: string, data: any) => Promise<null>;
}

interface ToggleBookmarkPayloadType {
    post: string;
